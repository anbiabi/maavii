                                ...
                                {featuredItems.map((item) => (
                                    <div key={item.id} className="p-4 bg-cream rounded-xl border-2 border-charcoal/5 hover:border-maaviiOrange transition-colors group">
                                        ...
                                        <button
                                            ...
                                            className="w-full py-2 bg-charcoal text-cream rounded-lg font-bold text-xs uppercase tracking-widest hover:bg-maaviiOrange transition-colors flex items-center justify-center gap-2"
                                        >
