    ...
    const groceryItems = [
        {
            ...
            description: 'Authentic Cameroon black pepper/nutmeg (Pebe) for authentic African cuisine'
        },
        {
            id: 2,
        ...
        },
        {
            ...
            price: '₩6,500',
            origin: 'Cameroon',
            image: '/images/food/corn_fufu_couscous_mais.jpg',
            description: 'Fine corn/cassava flour for plantain and traditional dishes'
        },
        {
            id: 4,
            name: 'Dried African Chilies (Pili-Pili)',
            category: 'Spices & Seasonings',
            price: '₩7,000',
            origin: 'Ghana',
            image: '/images/food/pili-pili.jpg',
        ...
        },
        {
            ...
            description: 'Fresh/Dried Bitter Leaves for the famous Ndole dish'
        },
        {
            id: 6,
