...
const MenuPreview: React.FC = () => {
    // Specifying the 6 requested images
    const menuImages = [
        { src: '/images/food/soya-brochettes-grill.jpg', alt: 'Beef Brochettes' },
        { src: '/images/food/chicken_skewers.jpg', alt: 'Chicken Skewers' },
        { src: '/images/food/meat-brochettes.jpg', alt: 'Mixed Meat Brochettes' },
        { src: '/images/food/ndole-fish-meal.jpg', alt: 'Ndole with Fish' },
        { src: '/images/food/rice-sauce-meal.jpg', alt: 'Rice and Sauce' },
        { src: '/images/food/puff puff.jpg', alt: 'Puff Puff' }
    ];
