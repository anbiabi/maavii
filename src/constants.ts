...
export const TRANSLATIONS: TranslationStrings = {
  ...
  checkoutMessage: { EN: 'Complete your order via:', KR: '주문 방법 선택:' },
  orderWhatsApp: { EN: 'Order via WhatsApp', KR: 'WhatsApp으로 주문' },
  orderKakao: { EN: 'Order via KakaoTalk', KR: '카카오톡으로 주문' },
  orderPhone: { EN: 'Call to Order', KR: '전화 주문' },
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    description: { EN: 'Sweet or savory deep-fried yeast dough, a perfect snack.', KR: '달콤하거나 짭짤히 튀긴 반죽 요리, 완벽한 간식.' },
    price: 8000,
