          ...
          <div className="p-6 bg-charcoal/[0.02] border-t border-charcoal/5 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className="w-full bg-deepRed text-maaviiYellow py-4 rounded-xl font-bold text-lg hover:bg-red-700 transition-colors shadow-lg flex items-center justify-center gap-2"
              >
