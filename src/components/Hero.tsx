    ...
    <section id="home" className="relative pt-32 pb-24 px-4 overflow-hidden scroll-mt-24 bg-maaviiYellow/10">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center relative z-10">
        <div className="space-y-12">
          ...
          {/* Description */}
          <p className="text-xl md:text-3xl text-charcoal/90 font-serif max-w-xl leading-relaxed border-l-[8px] md:border-l-[14px] border-maaviiTeal pl-6 md:pl-10 italic glass-vibrant p-8 md:p-12 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl hover:animate-float transition-all">
        ...
        <div className="relative group mt-12 lg:mt-0">
          {/* Main Visual with Fun Hover Effects */}
          <div className="aspect-square relative rounded-[2.5rem] md:rounded-[4rem] overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.2)] md:shadow-[0_60px_100px_rgba(0,0,0,0.3)] border-[10px] md:border-[20px] border-white rotate-2 transition-all group-hover:rotate-0 duration-700 hover:animate-jelly">
            <img
          ...
          {/* Floating tribal badge - with fun animation */}
          <div className="absolute -top-16 -right-16 vibrant-gradient p-14 rounded-full shadow-[0_30px_60px_rgba(0,0,0,0.3)] border-[10px] border-white text-white animate-spin-slow hover:animate-none hidden xl:block z-20 cursor-default hover:scale-110 transition-transform">
          ...
          <div className="absolute -bottom-8 md:-bottom-12 -left-4 md:-left-8 bg-white py-4 md:py-8 px-8 md:px-12 rounded-[2rem] md:rounded-[3rem] shadow-2xl border-l-[12px] md:border-l-[20px] border-maaviiTeal -rotate-3 group-hover:rotate-0 transition-all duration-500 hover:animate-float">
